...
class IptablesManager:
    """
    Gestionnaire IPS utilisant iptables - Version sécurisée et optimisée
    """
    ...
    def __init__(self, config, db_manager):
        ...
        # NOUVEAU: Validation et sécurité
    ...
    def block_ip(self, ip: str, reason: str, duration: Optional[int] = None) -> bool:
        """
        Bloque une adresse IP avec iptables - Version sécurisée
        ...
        # NOUVEAU: Validation stricte de l'IP
        ...
        # NOUVEAU: Vérifier la limite d'IPs bloquées
        with self.lock:
        ...
        # NOUVEAU: Limiter la durée de blocage
    ...
    def unblock_ip(self, ip: str) -> bool:
        """
        Débloque une adresse IP - Version sécurisée
    ...
    def _cleanup_thread(self):
        ...
        while not self.stop_event.is_set():
            ...
            # NOUVEAU: Intervalle de nettoyage adaptatif
