...
class BaseScanner(ABC):
    """Classe de base abstraite pour tous les scanners - Version optimisée"""
    ...
    def __init__(self, config: Dict[str, Any], db_manager: Any, ips_manager: Any):
        ...
        # NOUVEAU: Système de cycle adaptatif
        ...
        # NOUVEAU: Rate limiting pour les logs d'attaques
        ...
        # NOUVEAU: Whitelist dynamique avec cache
