...
class DatabaseManager:
    ...
    def __init__(self, config):
        """
        Initialisation du gestionnaire de base de données optimisé
        ...
        # NOUVEAU: Pool de connexions au lieu d'un seul lock global
        self.connection_pool = ConnectionPool(self.db_path, pool_size=8)
        
        # NOUVEAU: Cache pour les requêtes fréquentes
        self.query_cache = QueryCache(max_size=200, ttl=30.0)
        
        # NOUVEAU: Locks granulaires par table
        self.table_locks = {
        ...
        # NOUVEAU: Thread pool pour les opérations asynchrones
    ...
    def _init_database(self):
        ...
        with self.connection_pool.get_connection() as conn:
            ...
            # NOUVEAU: Table de statistiques pour éviter les calculs répétés
            cursor.execute('''
        ...
        try:
            with self.table_locks["blocked_ips"]:
                with self.connection_pool.get_connection() as conn:
                    ...
                    # Vérifier si l'IP est déjà bloquée (version optimisée)
                    cursor.execute(
    ...
    def cleanup_old_data(self):
        """Supprime les anciennes données - Version optimisée avec statistiques"""
